    ...
    <div class="flex w-full space-x-2">
      <div class="flex flex-col w-full space-y-2">
        ...
        <div class="flex flex-col space-y-2 w-full">
          <FileSaveButton
            ...
            filename="rsa.pri"
            :data="pubKey"
            >Save Public Key</FileSaveButton
          >
          <FileLoadButton
            class="btn btn-primary-1 w-full"
            @click="(val) => insertPublicKey(val)"
            >Load Public Key</FileLoadButton
          >
        </div>
        ...
        <div class="flex flex-col space-y-2 w-full">
          <FileLoadButton
            class="btn btn-primary-1 w-full"
            @click="(val) => (plaintext = val)"
            >Load Plaintext</FileLoadButton
          >
      ...
      <div class="flex flex-col w-full space-y-2">
        ...
        <div class="flex flex-col space-y-2 w-full">
          ...
          <FileLoadButton
            class="btn btn-primary-1 w-full"
            @click="(val) => insertPrivateKey(val)"
            >Load Private Key</FileLoadButton
          >
        </div>
        ...
        <div class="flex flex-col space-y-2 w-full">
          <FileLoadButton
            class="btn btn-primary-1 w-full"
            @click="(val) => (ciphertext = val)"
            >Load Ciphertext</FileLoadButton
          >
